...
/** Proxy signed POST to Pacifica `POST /api/v1/agent/bind`. */
export const POST: RequestHandler = async ({ request, locals }) => {
	...
	const url = new URL('/api/v1/agent/bind', `${normalizeBase(locals.pacificaApiBaseUrl)}/`);
